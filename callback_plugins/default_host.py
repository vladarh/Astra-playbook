...
class CallbackModule(CallbackBase):
    ...
    def record_msg_per_host(self, msg, delegated_vars):
        ...
        path = os.path.join(custom_path, "log_" + delegated_vars)
        # msg = to_bytes(msg +'\n\n')
        msg += '\n'
    ...
    def v2_runner_item_on_ok(self, result):
        ...
        if (self._display.verbosity > 0 or '_ansible_verbose_always' in result._result) and '_ansible_verbose_override' not in result._result:
            msg += " => %s" % self._dump_results(result._result)
        self.record_msg_per_host(self._display.display(msg, color=color), result._host.get_name())
        self._display.display(msg, color=color)
    ...
    def v2_playbook_on_include(self, included_file):
        ...
        self._display.display(msg, color=C.COLOR_SKIP)
        self.record_msg_per_host(self._display.display(msg), msg.split()[-1])
